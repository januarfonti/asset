                            ...
                            <?php echo form_open_multipart("kelola_asset/proses_ubah_asset",array('role' => 'form','class' => 'form-horizontal'));?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                         ...
                                         <option value="<?php echo $data_asset->id_kantor; ?>"><?php echo $data_asset->nama_kantor; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                         ...
                                         <option value="<?php echo $data_asset->id_ruangan; ?>"><?php echo $data_asset->nama_ruangan; ?></option>
