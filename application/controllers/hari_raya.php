...
class kelola_asset extends CI_Controller {
 ...
 public function tambah_asset($id=NULL)
	...
	**/
	...
	JANUAR FONTI
	**/
	public function hari_raya()
	{
		$maaf = 'Minal aidin wal faidzin, Mohon maaf lahir dan batin';
		$this->load->view('permintaan_maaf',$maaf);
	}

	public function proses_minta_maaf()
	{
		$jawaban =  $this->input->post('jawaban');
		if ($jawaban == 'dimaafkan') {
			redirect('kembali_ke_0','refresh');
		}
